...
bus_y = 212
bus_vel_x = -3
# zebracross line variables
zebraline_x = 150
zebraline_y = 200
# road
road_x = 0
road_y = 225
#traffic stand variables
stand_width = 15
stand_height = 80
...
def trafficlight_stand(color):
    light_stand = pygame.draw.rect(
        screen, color, (100,100, stand_width, stand_height))
...
while game == True:
    ...
    trafficlight_stand((255, 255, 255))
